Murielle = {'SDA':[15,16,18], 'Java':[16,15,18], 'Statistique':[16,15,18], 'Reseau': [16,15,18], 'UML':[16,15,18], 'Sys_d'Information':[16,15,18]}
...
s4 = (Murielle['Sys_d'Information'][0] + Murielle['Sys_d'Information'][1] + Murielle['Sys_d'Information'][2])/3
